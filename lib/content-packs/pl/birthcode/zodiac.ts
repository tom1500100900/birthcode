...
export const zodiacRoles = {
  Gemini: {
    Sun: [
      { id: "z_gemini_sun_01", text: "Słońce w Bliźniętach daje Ci naturalną ciekawość świata. Twoją największą siłą jest zdolność łączenia informacji i szybkie uczenie się nowych rzeczy." }
    ],
    Moon: [
